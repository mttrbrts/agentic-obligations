Run the Accord Project Phase 2 procurement demo. Follow these steps precisely and narrate each result clearly.
...
Expected: **REQUIRES_HUMAN_APPROVAL** (above $2,500 threshold). YTD advances to $5,300 (spend commits pending human sign-off).
